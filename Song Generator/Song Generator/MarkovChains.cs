...
namespace Engine {
	...
	public static class MarkovChains {
		...
		// in case the rhyming line was not found quickly enough we abandon the generated lines 
		// and start over again with other randomly generated words
		...
		/// <summary>
		/// Function generates a new line
		/// </summary>
		/// <param name="length">number of syllables in the line</param>
		/// <returns>generated line</returns>
		...
		/// <summary>
		/// Generate line given the two starting words
		/// </summary>
		/// <param name="length">number of syllables left to generate</param>
		/// <param name="syllableCount">number of syllables in the two specified words</param>
		/// <param name="currentWord">first word</param>
		/// <param name="nextWord">second word</param>
		/// <returns>generated line</returns>
